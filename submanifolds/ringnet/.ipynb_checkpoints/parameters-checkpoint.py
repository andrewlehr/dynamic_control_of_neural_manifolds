...
class Parameters:
    def __init__(self, params_to_update=None):
        ...
        self.shift_percent = 0.03  # percent shift of each neurons connectivity center
        ...
        self.stim = 'persistent'   # type of input, persistent or transient
    ...
    def _compute_derived_params(self):
        ...
        if self.stim == 'transient' and self.p_inh != 1 and self.rescale == True:
            ...
            self.weight_factor = (1 / (1 - self.p_inh)) 
        else:
